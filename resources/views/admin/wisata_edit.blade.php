                 ...
                 <div class="content-admin content-bg">
                     ...
                     @endif
                       ...
                       <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                               <input name="harga_tiket" value="{{ $data->harga_tiket }}" type="text" class="form-control" id="inputHargaTiket"
                                   placeholder="Rp.xxxx">
                           </div>
                       </div>
                       <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                               <input name="link_map" value="{{ $data->link_map }}" type="text" class="form-control" id="inputLinkMap"
                       ...
                       <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                               <textarea name="tips" class="form-control" id="inputTips" rows="4">{{ $data->tips }}</textarea>
                           </div>
                       </div>
                       <div class="form-group row">
